...
- [`b724dac`](https://github.com/KB-ML/tentacles/commit/b724dace85288e8562d2e28300106b18d9ff911a) Thanks [@NLumpov](https://github.com/NLumpov)! - Fix `validate.mode: "all"` (and `"change"`) not running validation on
